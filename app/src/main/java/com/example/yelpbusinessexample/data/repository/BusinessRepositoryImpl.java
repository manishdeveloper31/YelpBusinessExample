...
public class BusinessRepositoryImpl implements BusinessRepository {
    ...
    public void getBusinesses(HashMap<String, String> queryMap) {
        businessResponseCall = serviceApi.getBusinessesByDistance("Bearer XPFgzKwZGK1yqRxHi0d5xsARFOLpXIvccQj5jekqTnysweGyoIfVUHcH2tPfGq5Oc9kwKHPkcOjk2d1Xobn7aTjOFeop8x41IUfVvg2Y27KiINjYPADcE7Qza0RkX3Yx", queryMap);
